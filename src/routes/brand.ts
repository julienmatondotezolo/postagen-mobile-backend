...
const brands: Record<string, BrandData> = {
  "l-osteria": {
    ...
    description:
      "L'Osteria Deerlijk — Authentiek Italiaans familierestaurant gerund door Angelo en Jessica Bombini sinds 2003. De familiegeschiedenis in de Belgische horeca gaat terug tot 1964, toen Gianni Bombini zijn eerste zaak opende in Leuven. Meer dan 60 jaar Italiaanse kooktraditie, nu in het hart van Deerlijk. Verse ingrediënten, huisgemaakte pasta, en de warme sfeer van een echte Italiaanse famiglia. Adres: Stationsstraat 232, 8540 Deerlijk.",
    tone: "warm, uitnodigend, familiegericht, persoonlijk, trots op traditie, mix van Nederlands en Italiaans",
    languages: ["nl", "fr", "it"],
    menuHighlights: [
      "Aperol Spritz (€12)",
      "Limoncello Spritz (€13)",
      "L'Osteria Cocktail (€12)",
      "Cocktail Passione (€12)",
